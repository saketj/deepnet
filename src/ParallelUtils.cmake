...
macro(enable_cuda_support)
    ...
    # limit the number of register usage to 20
    set(CUDA_REGISTER_LIMIT TRUE)
    ...
    # Limit the number of registers if selected
    if(CUDA_REGISTER_LIMIT)
      list(APPEND CUDA_NVCC_FLAGS "--maxrregcount=20")
    endif()
